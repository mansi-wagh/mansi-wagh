...
**Techniques:** Supervised/Unsupervised ML · Feature Engineering · NLP (TF-IDF, BoW) · Real-time Inference
...
`GPIO · Hardware-Software Integration · Real-time Communication`
